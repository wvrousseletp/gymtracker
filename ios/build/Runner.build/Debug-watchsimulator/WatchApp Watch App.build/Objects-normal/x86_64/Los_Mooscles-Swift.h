...
#ifndef LOS_MOOSCLES_SWIFT_H
#define LOS_MOOSCLES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Los_Mooscles",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12Los_Mooscles17ExtensionDelegate")
@interface ExtensionDelegate : NSObject <UNUserNotificationCenterDelegate, WKApplicationDelegate>
- (void)applicationDidFinishLaunching;
- (void)handleWorkoutConfiguration:(HKWorkoutConfiguration * _Nonnull)workoutConfiguration;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12Los_Mooscles26WatchBackgroundSyncManager")
@interface WatchBackgroundSyncManager : NSObject
...
SWIFT_CLASS("_TtC12Los_Mooscles24WatchConnectivityManager")
...
SWIFT_CLASS("_TtC12Los_Mooscles14WorkoutManager")
...
@interface WorkoutManager (SWIFT_EXTENSION(Los_Mooscles)) <HKWorkoutSessionDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(Los_Mooscles)) <HKLiveWorkoutBuilderDelegate>
- (void)workoutBuilderDidCollectEvent:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder;
- (void)workoutBuilder:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder didCollectDataOfTypes:(NSSet<HKSampleType *> * _Nonnull)types;
@end
