    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // 1. Cabeçalho Unificado e Perfeitamente Adaptado
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Ações: Streak, Dicas e Configurações (tudo alinhado fluidamente)
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ProfileAvatar(
                          avatar: provider.currentProfile.avatar,
                          colorName: provider.currentProfile.colorAccent,
                          size: 32,
                          fontSize: 16,
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                provider.currentProfile.name.isNotEmpty ? provider.currentProfile.name : "Atleta",
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold,
